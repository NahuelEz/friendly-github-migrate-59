...
export default function ArticlesHero() {
  ...
  const filters = [
    ...
    { id: "crecimiento", label: "crecimiento en instagram" },
  ...
  const articles = [
    {
      ...
      content:
        "Lorem ipsum dolor sit amet consectetur. Tempus hendrerit netus quam orci velit. Lacus commodo ultricies ipsum in sed scelerisque. Id tempus purus nibh cursus etiam",
    },
    {
      id: 2,
      title: "Titular lorem ipsum dolor sit amet consectetur.",
  ...
  return (
    <div className="min-h-screen">
      <div
        className="p-6 pb-32 bg-gradient-to-b from-purple-500 to-purple-300"
        style={{
          backgroundImage:
            "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/%7B8D3533AF-457E-49ED-96A1-310791FEE17C%7D-hruWdEmoylsAvqmAbGKREQVXkiwV7T.png')",
      ...
      >
        <div className="max-w-7xl mx-auto">
          <h1
            className="text-5xl md:text-6xl font-bold text-purple-900 mb-12 mt-8"
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full border-2 transition-colors font-bold ${
                  activeFilter === filter.id
                    ...
                    : "bg-transparent text-purple-900 border-purple-300 hover:bg-purple-100/10"
                }`}
