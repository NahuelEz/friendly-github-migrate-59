...
export const TestimonialsSection: React.FC = () => {
  ...
  return <section className="self-center w-full max-w-[1360px] mt-[73px] max-md:max-w-full max-md:mt-10">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch py-0 my-[-80px]">
        <div className="w-[33%] max-md:w-full max-md:ml-0">
          <TestimonialCard name="Regina Miles" title="Designer" content={testimonialContent} rating={4} avatarSrc="/lovable-uploads/5ffcefde-547a-4ded-8190-6bf2ed91ca0c.png" />
        </div>
        <div className="w-[33%] ml-5 max-md:w-full max-md:ml-0">
          <TestimonialCard name="Regina Miles" title="Designer" content={testimonialContent} rating={5} avatarSrc="/lovable-uploads/5ffcefde-547a-4ded-8190-6bf2ed91ca0c.png" />
        </div>
        <div className="w-[33%] ml-5 max-md:w-full max-md:ml-0">
          <TestimonialCard name="Regina Miles" title="Designer" content={testimonialContent} rating={3} avatarSrc="/lovable-uploads/5ffcefde-547a-4ded-8190-6bf2ed91ca0c.png" />
        </div>
      </div>
    </section>;
};
