...
const Pricing = () => {
  return <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 relative">
        <div className="absolute inset-0 overflow-hidden">
          <img src="/lovable-uploads/9d722558-b268-4515-958b-c06ffb9418e6.png" alt="Esta pensado para vos background" className="w-full h-full object-cover" />
        </div>
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
          <div className="md:w-1/2 text-white mb-8 md:mb-0">
            <h2 className="text-5xl md:text-7xl font-bold leading-tight py-[152px] text-center text-[#000a00]/0">
              ESTA PENSADO
              <br />
              PARA VOS
            </h2>
      ...
      <section className="py-12 bg-[#d9d9d9]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center justify-items-center">
            {[1, 2, 3, 4, 5].map(i => <div key={i} className="text-xl font-bold text-[#181615]">
                LOGOCLIENT
              </div>)}
          </div>
        </div>
